...
def get_cli_args() -> str:
    ...
    parser.add_argument("language", choices=config.COMMAND_LINE_ARG_CHOICES)
...
def validate_config_keys():
    ...
    """
    for key in config.MANDATORY_KEYS:
...
def create_repo_files(config_list: List[str]):
    """
    Iterates through config.CONFIG and if the config_name is in the passed in list
